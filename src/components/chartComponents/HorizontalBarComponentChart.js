...
export class HorizontalBarComponentChart extends React.Component {
    ...
    createSummary = () => {
        ...
        if (achieved >= goal)
            styles = { color: '#0FA34D', textAlign: 'center', margin: 30, paddingBottom: '15px', fontFamily: 'Arial Black' }
        else
            styles = { color: '#d82020', textAlign: 'center', margin: 30, paddingBottom: '15px', fontFamily: 'Arial Black' }
